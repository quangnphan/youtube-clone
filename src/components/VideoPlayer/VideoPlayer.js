...
const VideoPlayer = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://www.googleapis.com/youtube/v3/videos?part=snippet%2C%20statistics&id=${videoId}&key=${process.env.REACT_APP_YOUTUBE_API_KEY}`
      )
      .then((response) => {
  ...
  return (
    <div className="videoplayer">
      <div className="videoplayer-videodetails">
        <div className="videoplayer-video">
          {isLoading ? (
        ...
        <div className="videoplayer-videoinfo">
          {!isLoading ? (
            <VideoInfo
